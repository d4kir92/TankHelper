...
function TankHelper:InitSettings()
	THTAB = THTAB or {}
	TankHelper:SetVersion(AddonName, 132362, "1.9.27")
	...
	TankHelper:CreateMinimapButton(
		{
			...
			["icon"] = 132362,
			["dbtab"] = THTAB,
			["vTT"] = {{"TankHelper |T132362:16:16:0:0|t", "v|cff3FC7EB1.9.27"}, {"Leftclick", "Options"}, {"Rightclick", "Toggle MinimapButton"}},
			["funcL"] = function()
	...
	thset = TankHelper:CreateFrame(
		{
			...
			["sw"] = 520,
			["sh"] = 520,
			["title"] = format("TankHelper |T132362:16:16:0:0|t by |cff3FC7EBD4KiR |T132115:16:16:0:0|t v|cff3FC7EB%s", "1.9.27")
		}
	)
